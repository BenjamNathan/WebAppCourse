...
namespace CourseApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(/*IAuthRepository repo*/ UserManager<User> userManager, IConfiguration config, IMapper mapper, SignInManager<User> signInManager)
        {
        ...
        private async Task<string> GenerateJwtToken(User user)
        {
            ...
            // This means that the token will also contain the roles in the claims
