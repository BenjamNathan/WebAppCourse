...
namespace CourseApp.API.Migrations
{
    ...
    [Migration("20181016152245_IdentityInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseApp.API.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CourseApp.API.Models.UserRole", b =>
                {
                    b.Property<int>("UserId");
            ...
            modelBuilder.Entity("CourseApp.API.Models.UserRole", b =>
                {
                    b.HasOne("CourseApp.API.Models.Role", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("CourseApp.API.Models.Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
